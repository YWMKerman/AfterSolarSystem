 ...
 **Q: Why does the Sun look so small in the AfterSolarSystem mod? Shouldn't the Sun's radius expand to the Earth's orbit at the end of its life?**
 
   *A: The Sun's radius will reach its peak during the AGB phase, expanding to a radius of 1 AU before becoming a white dwarf. I initially explored this idea in the 2020 ASS pilot version, but it wasn't feasible. The reasons are as follows: First, such a large radius would make the Solar System's habitable zone extremely distant, even beyond the orbit of Pluto. With such a large orbital radius, and with the Sun's mass reduced to only 50%-55% of its current mass, even Neptune would take 550 years or more to orbit the Sun. This would make progressing in the game extremely difficult, making it incredibly challenging to play. It's unlikely that all players would use mods like KSPIE, and a balanced gaming experience would be paramount.  The second and most critical issue is heat. KSP calculates heat based on the distance from the star's surface. This makes it impossible to reach the inner solar system, such as Earth, Mars, or Ceres, without resorting to cheating. It will make it impossible to get close and you will need to cheat. Even if your spacecraft itself can withstand high temperatures, all the scientific research instruments in stock cannot withstand high temperatures. Even if you have taken good insulation measures, the calculation of heat will be abnormal under high-rate time acceleration. Another problem is that Kopernicus will unload objects beyond a certain distance, which is about 70-80 AU. In the case of main sequence stars, the solar disk can no longer be seen clearly at such a distance, which is not a big deal. However, if the sun expands to 1 AU, the solar disk will still be clearly visible at such a long distance. In this case, the sun will disappear from the sky, but the lighting and sunflare given by the Scatterer Mod will still exist, which will look very strange.*

   *Even if you don't care about the above issues, you still can't accept the game's mediocre content. When the Sun becomes so large, its brightness and heat are staggering, inevitably causing the ice layers of the icy satellites of gas giants like Jupiter, Saturn, Uranus, and Neptune to evaporate, completely losing their atmospheres. If you saw that most celestial bodies in the galaxy were either covered in lava or bare rock spheres, you'd lose interest in the game to a significant degree.  In summary, the current time node in the AfterSolarSystem (the sun has just left the subgiant stage and entered the red giant stage) is a wise move. At this stage, the heat of the sun can still cause lava on the surfaces of Mercury, Venus, and the earth. It can also ensure that the ice on Jupiter's Galilean satellites, including Titan, can melt and form liquid water oceans. In addition, the appearance of some TNOs at this temperature can also give rise to better imagination. So for me personally this is a good choice.*
